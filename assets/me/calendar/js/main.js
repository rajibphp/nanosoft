$(function(){
    ...
    var base_url = '';
//    var base_url='http://[::1]/travel_kites/index.php/'; // Here i define the base_url
    ...
    $('#calendar').fullCalendar({
        ...
        dayClick: function(date, event, view) {
            ...
            modal({
                ...
                title: 'Add Holiday (' + date.format() + ')' // Modal title
//                title: 'Add Event (' + date.format() + ')' // Modal title
        ...
        eventClick: function(calEvent, jsEvent, view) {
            ...
            modal({
                ...
                title: 'Edit Holiday "' + calEvent.title + '"',
                event: calEvent
            });
        }
...
//        $('#color').val(data.event ? data.event.color : '#3a87ad');
        $('#color').val(data.event ? data.event.color : '#e20e45');
        // Create Butttons
